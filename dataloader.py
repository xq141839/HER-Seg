...
class BinaryLoader(Dataset):
        def __init__(self, data_name, jsfiles, transforms, pixel_mean=[123.675, 116.280, 103.530], pixel_std=[58.395, 57.12, 57.375]):
            if data_name == "mask_1024":
                self.path = f'/home/****/hd1/****/datasets'
            elif data_name == "mask_1024_c1":
                self.path = f'/home/****/datasets/REFUGE'
            elif data_name == "mask_1024_c2":
                self.path = f'/home/****/datasets/REFUGE'
            else:
                self.path = f'/home/****/datasets/Synapse/all'
        ...
        def __getitem__(self,idx):
            ...
            mask_path = os.path.join(self.path,f'{self.data_name}/',image_id)
...
class KDLoader(Dataset):
        def __init__(self, data_name, jsfiles, transforms, pixel_mean=[123.675, 116.280, 103.530], pixel_std=[58.395, 57.12, 57.375]):
            self.path = f'/home/****/datasets/SAM'
            self.jsfiles = jsfiles
            self.img_tesnor = pytorch_transforms.Compose([pytorch_transforms.ToTensor(), ])
            self.transforms = transforms
            self.img_size = 1024
        ...
        def __getitem__(self,idx):
            ...
            image_path = os.path.join(self.path,'image_1024/',self.jsfiles[idx])
            ...
            return (img_resized, img, image_id)
